...
class gradeJunController extends Controller
{
    public function index() {

        $firstYearFirstSem = [
    ["grade" => "1.50", "completion" => "", "code" => "ALM_CC 101", "description" => "Introduction to Computing", "units" => "3.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"],
    ...
    ["grade" => "1.75", "completion" => "", "code" => "ALM_GE 5", "description" => "Contemporary World", "units" => "3.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "2.00", "completion" => "", "code" => "ALM_GE 6", "description" => "Science Technology and Society", "units" => "3.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.25", "completion" => "", "code" => "ALM_GE 7", "description" => "Mathematics in the Modern World", "units" => "3.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.25", "completion" => "", "code" => "ALM_NSTP 1", "description" => "CWTS 1/ ROTC 1", "units" => "3.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.25", "completion" => "", "code" => "ALM_PE 1", "description" => "Movement Enhancement", "units" => "2.00", "term" => "1S of 2022", "prerequisite" => "", "remarks" => "Passed"]
...
$firstYearSecondSem = [
    ...
    ["grade" => "1.75", "completion" => "", "code" => "ALM_GE 3", "description" => "Reading Visual Arts", "units" => "3.00", "term" => "2S of 2022", "prerequisite" => "", "remarks" => "Passed"],
...
$secondYearFirstSem = [
    ["grade" => "1.75", "completion" => "", "code" => "ALM_CC 104", "description" => "Data Structures and Algorithm", "units" => "3.00", "term" => "1S of 2023", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.75", "completion" => "", "code" => "ALM_GE 4", "description" => "Purposive Communication", "units" => "3.00", "term" => "1S of 2023", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.75", "completion" => "", "code" => "ALM_GEE 1", "description" => "Living in the IT Era", "units" => "3.00", "term" => "1S of 2023", "prerequisite" => "", "remarks" => "Passed"],
    ...
    ["grade" => "1.50", "completion" => "", "code" => "ALM_OOP 101", "description" => "Object-Oriented Programming", "units" => "3.00", "term" => "1S of 2023", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.00", "completion" => "", "code" => "ALM_PE 3", "description" => "Physical Activity Towards Health and Fitness 3", "units" => "2.00", "term" => "1S of 2023", "prerequisite" => "", "remarks" => "Passed"],
];
...
$secondYearSecondSem = [
    ...
    ["grade" => "2.25", "completion" => "", "code" => "ALM_HCI 102", "description" => "Human Computer Interaction 2", "units" => "3.00", "term" => "2S of 2023", "prerequisite" => "", "remarks" => "Passed"],
    ...
    ["grade" => "2.00", "completion" => "", "code" => "ALM_NET 101", "description" => "Networking 1 (Fundamentals of Networking)", "units" => "3.00", "term" => "2S of 2023", "prerequisite" => "", "remarks" => "Passed"],
...
$thirdYearFirstSem = [
    ...
    ["grade" => "1.50", "completion" => "", "code" => "ALM_IM 102", "description" => "Information Management 2 (Advance Database System)", "units" => "3.00", "term" => "SM of 2024", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.50", "completion" => "", "code" => "ALM_MD 101", "description" => "Mobile Application Development 1", "units" => "3.00", "term" => "1S of 2024", "prerequisite" => "", "remarks" => "Passed"],
    ["grade" => "1.50", "completion" => "", "code" => "ALM_MS 102", "description" => "Quantitative Methods", "units" => "3.00", "term" => "1S of 2024", "prerequisite" => "", "remarks" => "Passed"],
