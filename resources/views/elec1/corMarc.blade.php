@extends('layouts.layout')
    ...
    <html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        <head>
            ...
            <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100..900;1, 100..900&family=UnifrakturMaguntia&display=swap" rel="stylesheet">
            <style>
                .no-border-style{
                    border-style: none;
        ...
        <body>
            ...
            <main>
                ...
                <div class="d-flex justify-content-center align-items-center flex-row pt-3 container ">

                    <div class="d-flex justify-content-center align-items-center flex-column"      style="margin-left: 6rem;">
                         <h4>Republic of the Philippines</h4>
                    <h4 >Pangasinan State University</h4>
                    <h4 >Alaminos City</h4>
                    </div>
                    <div>
                    <img src="{{ URL('psulogo.png') }}" alt="psu logo" class="img-fluid" >
                    </div>
                </div>

                <div class="container-fluid d-flex justify-content-center align-items-center flex-column">
                    <h3 >Pre-Enrollment Registration</h3>
                    <h3 >2nd Semester, 2024 - 2025</h3>
                    <h6 >Myrick Noel B. Clemente</h6>

                </div>
                <div class="container">
                    <div class="table-responsive-sm ">
                    <table class="table table-bordered border-black text-center  no-border-style">
                        <tr>
                            <th>Course Code</th>
                            <th>Course Title</th>
                            <th>Units</th>
